...
public class ShowGyms extends FragmentActivity {
    ...
    public void arrived(View view) {
        if (((latLng.latitude - 43.07145285968377 < 0.00035) & (latLng.latitude - 43.07145285968377 > -0.00035)) & ((latLng.longitude - -89.40668315134191 < 0.00035) & (latLng.longitude - -89.40668315134191 > -0.00035))) {
                    ...
                    try { //check for bad input
                        ...
                        if ((room > 100) & (room < 4500)) {
                            ...
                            if (room == 0) {
                                ...
                                //show 1st floor
                                Toast.makeText(ShowGyms.this, "1st Floor", Toast.LENGTH_LONG).show();
                            } else if (room == 2) {
                                //show 2nd floor
                                Toast.makeText(ShowGyms.this, "2nd Floor", Toast.LENGTH_LONG).show();
                            } else if (room == 3) {
                                //show 3rd floor
                            } else if (room == 4) {
                                //show 4th floor
                                ...
                                //SHOULD NOT BE HERE
                                Toast.makeText(ShowGyms.this, "SHOULD NOT BE HERE", Toast.LENGTH_LONG).show();
                            }
                        } else { //room number entered does not exist
                            Toast.makeText(ShowGyms.this, "Room number entered does not exist", Toast.LENGTH_LONG).show();
                        }
                    } catch (NumberFormatException e) { //room number is null
                        Toast.makeText(ShowGyms.this, "Please enter valid room number", Toast.LENGTH_LONG).show();
                    }
            ...
            Toast.makeText(ShowGyms.this, "No building maps found for selection", Toast.LENGTH_LONG).show();
        }
    }
